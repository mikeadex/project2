...
async function aiWriter(event) {
    ...
    const genAI = new GoogleGenerativeAI("AIzaSyB1nBz9boko8UhqP0jdMgM4aG_mFrn8C-8");
    const model = genAI.getGenerativeModel({ model: "gemini-1.5-flash" });

    let cvInput = document.getElementById("docx-text-output").innerText;
    const prompt = `you are a professional Human Resources Manager with over 45 years of experience . You have reviewed over 1 million resumes and have a keen eye for detail, You know what organisations are looking for in CVs. Your role is to rewrite the CV below to make it more appealing to employers. \n\n ${cvInput}`;
    console.log(prompt);
